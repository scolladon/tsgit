...
Every method bound on a `Repository` handle. 42 entries, alphabetical.
...
| [`fsck`](fsck.md) | Verify object integrity and connectivity; returns structured findings (no rendered line). |
