...
- Primitives: [`appendReflog`](../primitives/internals.md#appendreflog), [`readReflog`](../primitives/internals.md#readreflog), [`resolveReflogIdentity`](../primitives/internals.md#resolvereflogidentity), [`recordRefUpdate`](../primitives/internals.md#recordrefupdate)
