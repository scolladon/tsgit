...
### `buildPack`
`build-pack.ts`. Construct a packfile from an enumerated object set. Used by [`push`](../commands/push.md), [`packObjects`](../commands/pack-objects.md), [`bundle`](../commands/bundle.md) (`create`).
