...
describe('integration — gitignore end-to-end', () => {
  describe('Given a multi-level gitignore setup (global + info + root + nested with negation), When add --all + status', () => {
    it('Then ignore decisions match Git semantics', async () => {
