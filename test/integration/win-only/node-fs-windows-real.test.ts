...
describe('NodeFileSystem — Windows real-runner', () => {
  describe('Given a fresh mkdtemp working tree, When write/read round-trips', () => {
    it('Then the canonical-root reconciliation succeeds (8.3 short-name parent)', async () => {
...
describe('NodeFileSystem — Windows symlink refusal', () => {
  describe('Given a symlink leaf inside the working tree, When openWithNoFollow is called', () => {
    it('Then PERMISSION_DENIED is thrown', async ({ skip }) => {
