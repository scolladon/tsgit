...
describe('adapter + domain interop', () => {
  describe('Given a blob serialized by the domain, When written via Memory FS and read back', () => {
    it('Then roundtrips byte-identical', async () => {
      // Arrange
  ...
  describe('Given a blob hashed by the HashService, When hashed again via Hasher', () => {
    it('Then produces identical digest', async () => {
      // Arrange
      const ctx = createMemoryContext();
  ...
  describe('Given deflated bytes round-tripped through the Compressor, When compared to original', () => {
    it('Then matches', async () => {
      // Arrange
      const ctx = createMemoryContext();
  ...
  describe('Given an index serialized by the domain, When written via Memory FS and re-parsed', () => {
    it('Then the round-trip preserves all entries', async () => {
