...
describe.skipIf(!GIT_AVAILABLE)(
  ...
  () => {
    ...
    describe('Given leading whitespace added (none to some), When diffing with change mode (-b)', () => {
      it('Then diff is reported; with all (-w), Then no diff', async () => {
        // Arrange
    ...
    describe('Given internal space removed (a b to ab), When diffing with change mode (-b)', () => {
      it('Then diff is reported; with all (-w), Then no diff', async () => {
        // Arrange
    ...
    describe('Given leading whitespace kind/amount changed (tab to spaces), When diffing with change mode (-b)', () => {
      it('Then no diff; with at-eol, Then diff reported', async () => {
        // Arrange
    ...
    describe('Given $label, When diffing with change mode (-b)', () => {
      it.each(NO_DIFF_UNDER_CHANGE_MODE_MATRIX)('Then no diff', async ({ before, after }) => {
        // Arrange
    ...
    describe('Given trailing spaces removed, When diffing with at-eol mode', () => {
      it('Then no diff', async () => {
        // Arrange
    ...
    describe('Given CRLF lines become LF lines, When diffing with any EOL-touching mode', () => {
      it('Then no diff', async () => {
        // Arrange
    ...
    describe('Given mid-line CR (a CR b to ab), When diffing with ignoreCrAtEol or change mode', () => {
      it('Then diff is still reported', async () => {
        // Arrange
    ...
    describe('Given a file with a ws-only line and a real change, When diffing with all (-w)', () => {
      it('Then the patch shows the ws line as context with new bytes and the real line as changed', async () => {
        // Arrange
    ...
    describe('Given file f is ws-only change and file g is real change, When diffing with all (-w)', () => {
      it('Then only g appears in all output modes', async () => {
        // Arrange
    ...
    describe('Given ws-only change in unterminated last line (no trailing LF), When diffing with all (-w)', () => {
      it('Then no changes appear', async () => {
        // Arrange
    ...
    describe('Given a blank-only change (insert blank line), When diffing with ignoreBlankLines', () => {
      it('Then file stays in changes but numstat omits and patch is empty; quiet exits nonzero', async () => {
        // Arrange
    ...
    describe('Given g is blank-only and h has a real change, When diffing with ignoreBlankLines', () => {
      it('Then both appear in name-status but only h in numstat', async () => {
        // Arrange
    ...
    describe('Given a blank line inserted alongside c to C in one file, When diffing with ignoreBlankLines', () => {
      it('Then only the real change is counted', async () => {
        // Arrange
    ...
    describe('Given a spaces-only line inserted', () => {
      describe('When diffing with ignoreBlankLines alone (no -w)', () => {
        it('Then the change IS counted (spaces not blank without -w)', async () => {
          // Arrange
      ...
      describe('When diffing with ignoreBlankLines AND ignoreWhitespace all (-w)', () => {
        it('Then the file is dropped entirely', async () => {
          // Arrange
    ...
    describe('Given CRLF lines and a blank-line insertion, When diffing with ignoreCrAtEol plus ignoreBlankLines', () => {
      it('Then no diff', async () => {
        // Arrange
    ...
    describe('Given a rename whose dst differs from src only in whitespace, When diffing with detectRenames with or without ignoreWhitespace all', () => {
      it('Then the same rename pairing and similarity score is produced', async () => {
        // Arrange
