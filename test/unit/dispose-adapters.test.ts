...
describe('disposeAdapters', () => {
  ...
  describe('Given a ctx with one disposable port', () => {
    describe('When disposeAdapters runs', () => {
      it('Then that dispose is called exactly once', async () => {
        // Arrange
  ...
  describe('Given a ctx with multiple disposable ports', () => {
    describe('When disposeAdapters runs', () => {
      it('Then ALL dispose methods are called (no early bail)', async () => {
        // Arrange
  ...
  describe('Given a port whose dispose throws', () => {
    describe('When disposeAdapters runs', () => {
      it('Then the error is swallowed and other ports still dispose', async () => {
        // Arrange
        const fsDispose = vi.fn(async () => {
  ...
  describe('Given a port whose dispose throws AND a logger on ctx', () => {
    describe('When disposeAdapters runs', () => {
      it('Then logger.warn is called with the port key and error string', async () => {
        // Arrange
        const fsDispose = vi.fn(async () => {
          throw new Error('boom');
        });
  ...
  describe('Given a port whose dispose returns a non-Promise truthy dispose property', () => {
    describe('When disposeAdapters checks', () => {
      it('Then it skips that port (typeof check)', async () => {
        // Arrange
  ...
  describe('Given two concurrent calls', () => {
    describe('When disposeAdapters runs twice', () => {
      it('Then both resolve and each port dispose is called twice (no shared state)', async () => {
        // Arrange
        const dispose = vi.fn(async () => {});
        const ctx = withPort(baseCtx(), 'fs', { ...baseCtx().fs, dispose });
        const sut = disposeAdapters;
