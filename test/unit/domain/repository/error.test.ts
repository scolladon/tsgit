...
describe('domain repository error', () => {
  describe('factory data', () => {
    it('Given notARepository("/some/path"), When checking data, Then code and path preserved', () => {
      // Arrange & Act
    ...
    it('Given bareRepository("add"), When checking data, Then code and operation preserved', () => {
      // Arrange & Act
    ...
    it('Given alreadyInitialized("/repo/.git"), When checking data, Then code and path preserved', () => {
      // Arrange & Act
  ...
  describe('extractDetail message formatting (exact match)', () => {
    ...
    it.each(
      cases,
    )('Given repository error %j, When TsgitError(...).message is read, Then it equals the documented format', (data, expected) => {
      // Arrange & Act
