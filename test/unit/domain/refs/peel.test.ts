...
describe('peelOneLevel', () => {
  it('Given a Tag object, When peeling, Then returns { type: tag.data.objectType, id: tag.data.object }', () => {
    // Arrange
    const tag: Tag = {
      type: 'tag',
      id: SHA1,
  ...
  it('Given a Commit object, When peeling, Then returns { type: tree, id: commit.data.tree }', () => {
    // Arrange
    const commit: Commit = {
      type: 'commit',
      id: SHA1,
  ...
  it('Given a Blob object, When peeling, Then returns undefined', () => {
    // Arrange
    const blob: Blob = {
      type: 'blob',
      id: SHA1,
  ...
  it('Given a Tree object, When peeling, Then returns undefined', () => {
    // Arrange
    const tree: Tree = {
      type: 'tree',
      id: SHA1,
