...
describe('detectRenames', () => {
  it('Given diff with Add+Delete matching ObjectId on distinct paths, When detectRenames called, Then single RenameChange replaces the pair', () => {
    // Arrange
  ...
  it('Given diff with Add+Delete matching id but multiple deletion candidates, When detectRenames called, Then no fold — kept as add+delete', () => {
  ...
  it('Given diff with no matching add/delete pairs, When detectRenames called, Then same diff returned', () => {
  ...
  it('Given adds × deletes at limit exactly, When detectRenames called, Then rename detected', () => {
  ...
  it('Given adds x deletes product (3) just under limit (4), When detectRenames called, Then renames still detected', () => {
  ...
  it('Given adds × deletes at limit + 1, When detectRenames called, Then diff returned unchanged', () => {
  ...
  it('Given exactly maxSameIdDeletes deletes sharing one ObjectId with matching add, When detectRenames called, Then that id is skipped (ambiguity)', () => {
  ...
  it('Given maxSameIdDeletes + 1 deletes sharing one ObjectId, When detectRenames called, Then that id is pruned and adds remain as add+delete', () => {
  ...
  it('Given output after fold with mixed change types, When compared to byte-order invariant, Then sorted by primary path key per variant', () => {
  ...
  it('Given exactly 1 delete with matching add and maxSameIdDeletes=1, When detectRenames called, Then rename found (at boundary)', () => {
