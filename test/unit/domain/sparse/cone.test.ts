...
describe('buildConeSpec', () => {
  describe('Given a single nested directory', () => {
    describe('When built', () => {
      it('Then recursive holds it and parents holds its ancestors', () => {
        // Arrange
        const dirs = ['a/b/c'];
  ...
  describe('Given sibling directories', () => {
    describe('When built', () => {
      it('Then parents is their shared ancestor', () => {
        // Arrange
  ...
  describe('Given a directory that is also an ancestor of another', () => {
    describe('When built', () => {
      it('Then it stays recursive and is not a parent', () => {
  ...
  describe('Given a root-level directory', () => {
    describe('When built', () => {
      it('Then parents stays empty (root is implicit)', () => {
        // Arrange
        const dirs = ['docs'];
  ...
  describe('Given a directory with leading and trailing slashes', () => {
    describe('When built', () => {
      it('Then they are stripped', () => {
        // Arrange
        const dirs = ['/src/app/'];
  ...
  describe('Given a directory with backslash separators', () => {
    describe('When built', () => {
      it('Then they become POSIX slashes', () => {
        // Arrange
        const dirs = ['src\\app'];
  ...
  describe('Given duplicate directories', () => {
    describe('When built', () => {
      it('Then they are deduped', () => {
        // Arrange
        const dirs = ['src', 'src'];
  ...
  describe('Given a directory that normalises to empty', () => {
    describe('When built', () => {
      it('Then it throws an invalid-segment INVALID_OPTION', () => {
  ...
  describe('Given a directory with doubled leading slashes', () => {
    describe('When built', () => {
      it('Then every leading slash is stripped', () => {
  ...
  describe('Given a directory with doubled trailing slashes', () => {
    describe('When built', () => {
      it('Then every trailing slash is stripped', () => {
        // Arrange — pins the `+` quantifier in the `/\/+$/` strip regex.
        const dirs = ['src//'];
  ...
  describe('Given a directory with a "." segment', () => {
    describe('When built', () => {
      it('Then it throws an invalid-segment INVALID_OPTION', () => {
        // Arrange
        const dirs = ['src/./app'];
  ...
  describe('Given a directory with a "*" metacharacter', () => {
    describe('When built', () => {
      it('Then it throws a glob-metacharacter INVALID_OPTION', () => {
        // Arrange
        const dirs = ['srcdir*'];
  ...
  describe('Given an empty segment in the middle', () => {
    describe('When built', () => {
      it('Then it throws INVALID_OPTION', () => {
...
describe('coneMatcher', () => {
  describe('Given a root-level file', () => {
  ...
  describe('Given a file directly inside a parent directory', () => {
    describe('When matched', () => {
      it('Then it is included', () => {
  ...
  describe('Given a file in a non-recursive subdirectory of a parent directory', () => {
    describe('When matched', () => {
  ...
  describe('Given a file inside a recursive directory', () => {
    describe('When matched', () => {
      it('Then it is included', () => {
        // Arrange
        const sut = coneMatcher(buildConeSpec(['src/app']));
  ...
  describe('Given a deeply nested file under a recursive directory', () => {
    describe('When matched', () => {
      it('Then it is included', () => {
  ...
  describe('Given a file fully outside the cone', () => {
    describe('When matched', () => {
      it('Then it is excluded', () => {
        // Arrange
        const sut = coneMatcher(buildConeSpec(['src/app']));
...
describe('parseCone', () => {
  ...
  describe('Given text with a wrong first header line', () => {
    describe('When parsed', () => {
  ...
  describe('Given text with a wrong second header line', () => {
    describe('When parsed', () => {
      it('Then it returns undefined', () => {
        // Arrange
        const text = '/*\n!/x/\n/docs/\n';
  ...
  describe('Given a body line that is not a "/<d>/" line', () => {
    describe('When parsed', () => {
      it('Then it returns undefined', () => {
  ...
  describe('Given a body line ending without a slash', () => {
    describe('When parsed', () => {
      it('Then it returns undefined', () => {
        // Arrange
        const text = '/*\n!/*/\n/src\n';
  ...
  describe('Given an empty "//" directory line', () => {
    describe('When parsed', () => {
      it('Then it returns undefined', () => {
        // Arrange
        const text = '/*\n!/*/\n//\n';
  ...
  describe('Given an orphan negated wildcard line', () => {
    describe('When parsed', () => {
      it('Then it returns undefined', () => {
  ...
  describe('Given a slash-bounded line whose inner part starts with "!"', () => {
    describe('When parsed', () => {
      it('Then it returns undefined', () => {
