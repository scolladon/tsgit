...
describe('upload-pack integration — discovery', () => {
  describe('Given a discovery body with HEAD + refs/heads/main + a peeled tag', () => {
    describe('When parsed end-to-end', () => {
      it('Then capabilities, refs, and head match', async () => {
        // Arrange
...
describe('upload-pack integration — clone response', () => {
  describe('Given a single-round clone response with packBytes', () => {
    describe('When parsed end-to-end', () => {
      it('Then nak true and packBody matches packBytes byte-for-byte', async () => {
        // Arrange
  ...
  describe('Given a multi-round response with acks', () => {
    describe('When parsed', () => {
      it('Then acks deep-equals input', async () => {
        // Arrange
        const body = buildUploadPackResponseBody({
          acks: [
