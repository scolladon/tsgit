...
describe('stripspace properties', () => {
  describe('Given an arbitrary commit message', () => {
    describe('When stripspace runs twice', () => {
...
describe('subjectLine properties', () => {
  describe('Given an arbitrary commit message', () => {
    describe('When subjectLine runs twice', () => {
      it('Then the second pass is a no-op (idempotent)', () => {
        // Arrange + Act + Assert
        fc.assert(
          fc.property(arbCommitMessage(), (message) => {
    ...
    describe('When subjectLine runs', () => {
...
describe('foldSubject properties', () => {
  describe('Given an arbitrary commit message', () => {
    describe('When foldSubject runs twice', () => {
      it('Then the second pass is a no-op (idempotent)', () => {
        // Arrange + Act + Assert
        fc.assert(
          fc.property(arbCommitMessage(), (message) => {
    ...
    describe('When foldSubject runs', () => {
      it('Then the result never contains a newline', () => {
        // Arrange + Act + Assert
        fc.assert(
          fc.property(arbCommitMessage(), (message) => {
  ...
  describe('Given a non-blank subject and an arbitrary body', () => {
    describe('When foldSubject runs', () => {
