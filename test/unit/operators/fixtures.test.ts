...
describe('trackedRange', () => {
  it('Given a trackedRange(3), When iteration completes normally, Then returnCalled() is false', async () => {
    // Arrange
  ...
  it('Given a trackedRange(10), When consumer breaks at item 3, Then returnCalled() is true', async () => {
    // Arrange
...
describe('pullCounter', () => {
  it('Given a pullCounter, When no iteration happens, Then pullCount() is 0', () => {
    // Arrange / Act
  ...
  it('Given a pullCounter, When consumer pulls 5 items, Then pullCount() is 5', async () => {
    // Arrange
    const sut = pullCounter();
...
describe('throwingAt', () => {
  it('Given a throwingAt(2, 10), When consumer pulls past item 1, Then iteration throws on item 2', async () => {
    // Arrange
...
describe('awaitable', () => {
  it('Given awaitable(() => true), When awaited, Then resolves to true AND is NOT a Promise', async () => {
    // Arrange
...
describe('abortableRange', () => {
  it('Given abortableRange(3, 10), When iterated to completion, Then exactly [0,1,2] is yielded', async () => {
    // Arrange
...
describe('throwingPredicate', () => {
  it('Given throwingPredicate(x => x === 2, err), When called with 1 then 2, Then 1 resolves false and 2 rejects with err', async () => {
    // Arrange
...
describe('trackedPipeline4', () => {
  it('Given a trackedPipeline4 composed with a manual for-await consumer breaking at 3, When iteration exits, Then all four stage return flags are true', async () => {
    // Arrange
