...
describe('groupBy', () => {
  describe('Given an empty source', () => {
    describe('When awaited', () => {
      it('Then an empty Map is returned', async () => {
        // Arrange
  ...
  describe('Given a source [1] keyed by identity', () => {
    describe('When awaited', () => {
      it('Then result has one entry { 1 → [1] }', async () => {
        // Arrange
        const sut = groupBy((n: number) => n);
  ...
  describe('Given a source [1, 1] keyed by identity', () => {
    describe('When awaited', () => {
      it('Then result has one entry { 1 → [1, 1] }', async () => {
        // Arrange
        const sut = groupBy((n: number) => n);
  ...
  describe('Given a source [1,2,3] keyed by identity', () => {
    describe('When awaited', () => {
      it('Then three entries of size 1 each', async () => {
        // Arrange
        const sut = groupBy((n: number) => n);
  ...
  describe('Given a source [a,b,a,b,a] keyed by identity', () => {
    describe('When awaited', () => {
      it('Then two entries a → [a,a,a], b → [b,b] in first-occurrence order', async () => {
        // Arrange
  ...
  describe('Given a source [x, y] keyed to someConst', () => {
    describe('When awaited', () => {
      it('Then [...result.keys()] equals [someConst]', async () => {
        // Arrange
        const someConst = 'K';
  ...
  describe('Given a source [NaN, NaN] keyed by identity', () => {
    describe('When awaited', () => {
      it('Then result.get(NaN) has length 2 (SameValueZero)', async () => {
        // Arrange
        const sut = groupBy((n: number) => n);
  ...
  describe('Given two items keyed to distinct fresh {} literals', () => {
    describe('When awaited', () => {
      it('Then two entries of size 1 each', async () => {
        // Arrange
        const items = [1, 2];
        const sut = groupBy(() => ({}));
  ...
  describe('Given two items keyed to the same frozen object', () => {
    describe('When awaited', () => {
      it('Then one entry of size 2', async () => {
        // Arrange
  ...
  describe('Given a throwingPredicate as keyFn that throws on item k', () => {
    describe('When awaited', () => {
      it('Then promise rejects AND source returnCalled() is true', async () => {
        // Arrange
  ...
  describe('Given a source of 5 items and limit = 3', () => {
    describe('When awaited', () => {
      it('Then RangeError /exceeded limit of 3/', async () => {
        // Arrange
  ...
  describe('Given groupBy(k, -1)', () => {
    describe('When factory invoked', () => {
      it('Then RangeError synchronously at construction time', () => {
        // Arrange + Act + Assert
        try {
  ...
  describe('Given groupBy(k, 0) at factory time', () => {
    describe('When called', () => {
      it('Then it does not throw (0 is a valid limit)', () => {
        // Arrange
  ...
  describe('Given groupBy(k, 0) on a one-item source', () => {
    describe('When awaited', () => {
  ...
  describe('Given the property "Array.from(result.values()).flat() is a permutation of toArray(source) for any source and keyFn"', () => {
      ...
      it('Then it holds', async () => {
        ...
        await fc.assert(
          fc.asyncProperty(fc.array(fc.integer(), { maxLength: 30 }), async (input) => {
            ...
            return (
              flattened.length === input.length && sortedIn.every((v, i) => v === sortedOut[i])
            );
          }),
          { numRuns: 50 },
        );
