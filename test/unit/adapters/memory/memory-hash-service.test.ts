...
describe('MemoryHashService', () => {
  ...
  describe('memory-specific behaviors', () => {
    describe('Given SHA-256 algorithm', () => {
      describe('When hashing', () => {
        it('Then returns 32-byte digest', async () => {
          // Arrange
    ...
    describe('Given SHA-1 known vector', () => {
      describe('When hashHex', () => {
        it('Then returns expected digest', async () => {
          // Arrange
    ...
    describe('Given Hasher mutated input buffer after update', () => {
      describe('When digesting', () => {
        it('Then uses original bytes', async () => {
          // Arrange
          const sut = new MemoryHashService('sha1');
          const hasher = sut.createHasher();
    ...
    describe('Given crypto.subtle unavailable', () => {
      describe('When constructing', () => {
        it('Then throws HASH_FAILED with subtle-unavailable reason', () => {
          // Arrange
