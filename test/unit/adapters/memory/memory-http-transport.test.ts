...
describe('MemoryHttpTransport', () => {
  ...
  describe('memory-specific behaviors', () => {
    it('Given unregistered URL, When requesting, Then throws NETWORK_ERROR with URL-echoing reason', async () => {
      // Arrange
      const sut = new MemoryHttpTransport();
    ...
    it('Given mock then clearMocks, When requesting, Then throws NETWORK_ERROR', async () => {
      // Arrange
      const sut = new MemoryHttpTransport();
      sut.addMockResponse({
        method: 'GET',
    ...
    it('Given mock response, When reading body stream, Then yields seeded bytes', async () => {
      // Arrange
      const sut = new MemoryHttpTransport();
    ...
    it('Given mock source buffer mutated after addMockResponse, When requesting, Then response body still contains original bytes', async () => {
    ...
    it('Given consecutive requests to the same mock, When mutating the raw first chunk, Then second request returns pristine bytes', async () => {
    ...
    it('Given method-specific mocks, When requesting wrong method, Then throws NETWORK_ERROR', async () => {
      // Arrange
      const sut = new MemoryHttpTransport();
      sut.addMockResponse({
        method: 'GET',
