...
describe('NodeHashService', () => {
  ...
  describe('node-specific behaviors', () => {
    it('Given sha256 algorithm, When hashing "abc", Then returns known sha256 digest', async () => {
      // Arrange
    ...
    it('Given default constructor, When instantiating, Then algorithm is sha1', async () => {
      // Arrange / Act
    ...
    it('Given Hasher after digest, When digestHex, Then throws HASH_FAILED with digest-after-digest reason', async () => {
      // Arrange
    ...
    it('Given Hasher after digestHex, When digest, Then throws HASH_FAILED with digest-after-digest reason', async () => {
