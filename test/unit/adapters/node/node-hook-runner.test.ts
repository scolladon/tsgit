...
describe('adapters/node NodeHookRunner — isRunnable', () => {
  ...
  describe('Given a regular file with no executable bit on Windows', () => {
    describe('When run', () => {
      it('Then the hook is spawned', async () => {
...
describe('adapters/node NodeHookRunner — spawn wiring', () => {
  describe('Given an executable hook', () => {
    describe('When run', () => {
      it('Then spawn receives the path, args, cwd and git env', async () => {
        // Arrange
        const { runner, child, calls } = makeHarness();
  ...
  describe('Given a hook that exits 0 with output', () => {
    describe('When run', () => {
      it('Then stdout and stderr are captured', async () => {
        // Arrange
  ...
  describe('Given the spawn emits an error', () => {
    describe('When run', () => {
      it('Then exit code 126 with the error text is reported', async () => {
        // Arrange
        const { runner, child } = makeHarness();
  ...
  describe('Given a hook that emits more than the output cap', () => {
    describe('When run', () => {
      it('Then captured stdout is bounded', async () => {
        // Arrange
        const { runner, child } = makeHarness();
  ...
  describe('Given a hook that errors on stdin (EPIPE)', () => {
    describe('When run', () => {
      it('Then it still resolves', async () => {
        // Arrange
        const { runner, child } = makeHarness();
...
describe('adapters/node NodeHookRunner — abort handling', () => {
  ...
  describe('Given a signal that aborts mid-run', () => {
    describe('When the signal fires', () => {
      it('Then the child is killed', async () => {
        // Arrange
        const controller = new AbortController();
        const { runner, child } = makeHarness();
  ...
  describe('Given no signal', () => {
    describe('When run', () => {
      it('Then the child is not killed', async () => {
        // Arrange
        const { runner, child } = makeHarness();
  ...
  describe('Given a signal', () => {
    describe('When the hook completes before any abort', () => {
      it('Then a later abort does not kill the child', async () => {
        // Arrange
        const controller = new AbortController();
        const { runner, child } = makeHarness();
