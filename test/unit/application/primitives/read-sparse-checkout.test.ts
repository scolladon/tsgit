...
describe('primitives/read-sparse-checkout', () => {
  ...
  describe('readSparsePatternText', () => {
    it('Given no sparse-checkout file, When readSparsePatternText, Then returns undefined', async () => {
      // Arrange
    ...
    it('Given a sparse-checkout file, When readSparsePatternText, Then returns its UTF-8 text', async () => {
      // Arrange
      const ctx = createMemoryContext();
    ...
    it('Given a file exactly at the byte cap, When readSparsePatternText, Then it is accepted', async () => {
    ...
    it('Given a file one byte over the cap, When readSparsePatternText, Then it throws SPARSE_PATTERN_FILE_TOO_LARGE', async () => {
    ...
    it('Given fs.read rejects with a non-FILE_NOT_FOUND TsgitError, When readSparsePatternText, Then the error propagates', async () => {
    ...
    it('Given fs.read rejects with a non-TsgitError, When readSparsePatternText, Then the error is rethrown', async () => {
      // Arrange
      const ctx = createMemoryContext();
  ...
  describe('loadSparseMatcher', () => {
    it('Given core.sparseCheckout absent, When loadSparseMatcher, Then returns undefined', async () => {
    ...
    it('Given core.sparseCheckout = false, When loadSparseMatcher, Then returns undefined', async () => {
    ...
    it('Given core.sparseCheckout = true with a cone file, When loadSparseMatcher, Then a cone matcher is built', async () => {
    ...
    it('Given core.sparseCheckout = true with non-cone mode, When loadSparseMatcher, Then a non-cone matcher is built', async () => {
    ...
    it('Given core.sparseCheckout = true with no pattern file, When loadSparseMatcher (non-cone), Then an includes-nothing matcher is built', async () => {
    ...
    it('Given a cone-shaped file but cone NOT requested, When loadSparseMatcher, Then it is parsed as non-cone (a root file is excluded)', async () => {
    ...
    it('Given the same cone-shaped file WITH cone requested, When loadSparseMatcher, Then it is parsed as cone (a root file is included)', async () => {
    ...
    it('Given a cone-requested config but a non-cone-shaped file, When loadSparseMatcher, Then it logs one warning and falls back', async () => {
    ...
    it('Given a degraded cone parse but no logger, When loadSparseMatcher, Then it still builds a matcher without throwing', async () => {
