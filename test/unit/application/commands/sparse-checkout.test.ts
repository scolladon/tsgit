...
describe('sparseCheckout command', () => {
  ...
  describe('list', () => {
    describe('Given sparse disabled', () => {
      describe('When list', () => {
        it('Then returns empty non-cone list', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given a cone repo', () => {
      describe('When list', () => {
        it('Then returns the sorted recursive directories', async () => {
    ...
    describe('Given a non-cone repo', () => {
      describe('When list', () => {
        it('Then returns the raw pattern lines verbatim', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given sparse enabled with no pattern file', () => {
      describe('When list', () => {
    ...
    describe('Given a cone-shaped file but non-cone config', () => {
      describe('When list', () => {
        it('Then it is read as non-cone raw lines', async () => {
    ...
    describe('Given a hand-written unsorted cone file', () => {
      describe('When list', () => {
        it('Then the recursive dirs are sorted', async () => {
  ...
  describe('set', () => {
    describe('Given empty patterns', () => {
      describe('When set', () => {
        it('Then throws INVALID_OPTION for patterns', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();

          // Act
          const err = await expectError(() => sparseCheckoutSet(ctx, { patterns: [] }));
    ...
    describe('Given a cone of docs', () => {
      describe('When set', () => {
        it('Then both src files are removed and docs stays', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given a cone of src/app', () => {
      describe('When set', () => {
        it('Then src/util.ts stays as a navigable parent file', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given cone set', () => {
      describe('When set', () => {
        it('Then config records sparseCheckout and cone true and the file is the cone shape', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given non-cone patterns', () => {
      describe('When set', () => {
        it('Then the file is the raw lines and cone is false', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given no explicit cone flag', () => {
      describe('When set', () => {
        it('Then cone defaults to true', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
    ...
    describe('Given an existing non-cone repo and no cone flag', () => {
      describe('When set', () => {
        it('Then the prior cone mode is reused', async () => {
    ...
    describe('Given a failed apply (index locked)', () => {
      describe('When set', () => {
        it('Then config and pattern file are untouched', async () => {
          ...
          const err = await expectError(() =>
            sparseCheckoutSet(ctx, { patterns: ['src/app'], cone: true }),
          );
    ...
    describe('Given non-cone mode with cone-shaped patterns', () => {
      describe('When set', () => {
        it('Then they stay non-cone', async () => {
  ...
  describe('add', () => {
    describe('Given empty patterns', () => {
      describe('When add', () => {
        it('Then throws INVALID_OPTION for patterns', async () => {
          ...
          // Act
          const err = await expectError(() => sparseCheckoutAdd(ctx, { patterns: [] }));
    ...
    describe('Given sparse disabled', () => {
      describe('When add', () => {
        it('Then throws INVALID_OPTION for action', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();

          // Act
          const err = await expectError(() => sparseCheckoutAdd(ctx, { patterns: ['docs'] }));
    ...
    describe('Given a cone repo', () => {
      describe('When add', () => {
        it('Then the new directory is folded into the cone and materialised', async () => {
    ...
    describe('Given a cone repo whose pattern file was hand-written non-cone-shaped', () => {
      describe('When add a directory', () => {
        it('Then the cone is rebuilt from only the added dirs', async () => {
    ...
    describe('Given a non-cone repo', () => {
      describe('When add', () => {
        it('Then the new pattern lines are appended to the file', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
          await sparseCheckoutSet(ctx, { patterns: ['/src/'], cone: false });

          // Act
          await sparseCheckoutAdd(ctx, { patterns: ['/docs/'] });
    ...
    describe('Given non-cone enabled with no pattern file', () => {
      describe('When add', () => {
        it('Then the file holds only the new lines', async () => {
    ...
    describe('Given non-cone mode', () => {
      describe('When add makes the combined file cone-shaped', () => {
        it('Then it stays non-cone', async () => {
          // Arrange — non-cone mode whose file is already the cone header.
          const ctx = await seedRepoWithTree();
          await sparseCheckoutSet(ctx, { patterns: ['/*', '!/*/'], cone: false });
  ...
  describe('reapply', () => {
    describe('Given sparse disabled', () => {
      describe('When reapply', () => {
        it('Then throws INVALID_OPTION for action', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();

          // Act
          const err = await expectError(() => sparseCheckoutReapply(ctx));
    ...
    describe('Given a cone repo with a re-created excluded file', () => {
      describe('When reapply', () => {
        it('Then the on-disk patterns are re-enforced', async () => {
    ...
    describe('Given a non-cone repo', () => {
      describe('When reapply', () => {
        it('Then the result reports cone false and no file is rewritten', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
          await sparseCheckoutSet(ctx, { patterns: ['/src/'], cone: false });
  ...
  describe('disable', () => {
    describe('Given a cone repo', () => {
      describe('When disable', () => {
        it('Then every file is re-materialised and config flips to false', async () => {
          // Arrange — narrow to the docs cone (both src files excluded), then disable.
          const ctx = await seedRepoWithTree();
          await sparseCheckoutSet(ctx, { patterns: ['docs'], cone: true });
          expect(await fileExists(ctx, 'src/util.ts')).toBe(false);
    ...
    describe('Given a disabled repo', () => {
      describe('When disable', () => {
        it('Then the pattern file is kept on disk', async () => {
          // Arrange
          const ctx = await seedRepoWithTree();
          await sparseCheckoutSet(ctx, { patterns: ['src/app'], cone: true });

          // Act
          await sparseCheckoutDisable(ctx);
  ...
  describe('dirty-file retention', () => {
    describe('Given a modified out-of-cone file and no force', () => {
      describe('When set', () => {
    ...
    describe('Given a modified out-of-cone file and force', () => {
      describe('When set', () => {
