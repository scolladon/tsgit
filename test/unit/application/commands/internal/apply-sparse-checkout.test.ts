...
describe('commands/internal/apply-sparse-checkout', () => {
  it('Given an excluded clean file, When applySparseCheckout narrows, Then the file is removed and skip-worktree is set', async () => {
  ...
  it('Given an included entry whose file is absent, When applySparseCheckout widens, Then the file is written and skip-worktree is cleared', async () => {
  ...
  it('Given an excluded file with uncommitted edits and no force, When applySparseCheckout, Then the file is retained', async () => {
  ...
  it('Given an excluded file with uncommitted edits and force, When applySparseCheckout, Then the file is removed', async () => {
  ...
  it('Given a matcher of undefined, When applySparseCheckout, Then every absent file is re-materialised and every skip bit cleared', async () => {
  ...
  it('Given a mix of widen, narrow and noop entries, When applySparseCheckout, Then materialized and removed counts are exact', async () => {
  ...
  it('Given an excluded entry whose file is already absent, When applySparseCheckout narrows, Then it is a noop and the bit is set', async () => {
  ...
  it('Given a non-stage-0 entry, When applySparseCheckout, Then it is ignored and absent from the new index', async () => {
  ...
  it('Given the index lock is already held, When applySparseCheckout, Then it throws RESOURCE_LOCKED', async () => {
  ...
  it('Given a widened entry, When applySparseCheckout, Then its committed index entry carries the post-write stat', async () => {
  ...
  it('Given an included entry that is skip-worktree but already on disk, When applySparseCheckout, Then it is a noop that clears the bit', async () => {
  ...
  it('Given a changeset with add/delete entries, When applySparseCheckout, Then the progress total equals the non-noop entry count', async () => {
  ...
  it('Given applyChangeset throws mid-apply, When applySparseCheckout, Then the index lock is released', async () => {
